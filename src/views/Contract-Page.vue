  ...
  data() {
    return {
      ...
      formData: {
        client1: 'Suzy Mills',
        client2: 'Sean Reidy',
        chosenPackage: 'White Diamond special offer',
        dateOfWedding: '24th July 2025',
        hoursIncluded: '9',
        prepTime: '',
        ceremonyTime: '',
        endingTime: '',
        otherArrangements: '2 Hours free special offer, 9 hour total',
        clientAddress1: '',
        clientAddress2: '',
        clientAddress3: '',
        clientEmail1: '',
      ...
      dropboxAccessToken: 'sl.B_Pp2-4k1jdRWHAdN3oJsl6GxX9zDzUC8lA-JjVym6liv5u1LM90eaPW_Y4Q8ZczMnwTiK_OYwA_PEngFm0gku923kb0LaWPiI5JYLCBhoea9lfxwjDMwWzKhFTCOkdKxnVwpJCDKfRV1uw', // Replace with your Dropbox Access Token
